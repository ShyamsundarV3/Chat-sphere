import { Text, Flex, Box, VStack, Link, Avatar, Button, useToast, Portal, Menu, MenuButton, MenuItem, MenuList } from "@chakra-ui/react";
    ...
    <VStack gap={4} alignItems={"start"} w="full">
      ...
      <Flex w={"full"} justifyContent={"space-between"}>
        <Flex gap={2} alignItems={"center"}>
          ...
          <Link color={"gray.link"} href="https://instagram.com" isExternal>instagram.com</Link>
        </Flex>
        <Flex>
